...
int hashes_init_stage1(hashconfig_t *hashconfig, hashes_t *hashes)
{
	...
	*/
	...
	u32 hashlist_mode = 0;
	u32 hashlist_format = 0; // HLFMT_HASHCAT;

	u32 hashes_avail = 0;

	if (true) //(user_options->benchmark == false) && (user_options->stdout_flag == false) && (user_options->keyspace == false))
	{
