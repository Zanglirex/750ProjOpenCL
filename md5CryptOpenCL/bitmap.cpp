...
int bitmap_ctx_init(bitmap_ctx_t   *bitmap_ctx, hashconfig_t   *hashconfig, hashes_t *hashes)
{
	...
	*/
	...
	const u32 bitmap_min = 16; // BITMAP_MIN
	const u32 bitmap_max = 24; // BITMAP_MAX

	u32 *bitmap_s1_a = (u32 *)malloc((1u << bitmap_max) * sizeof(u32));
	u32 *bitmap_s1_b = (u32 *)malloc((1u << bitmap_max) * sizeof(u32));
	u32 *bitmap_s1_c = (u32 *)malloc((1u << bitmap_max) * sizeof(u32));
	u32 *bitmap_s1_d = (u32 *)malloc((1u << bitmap_max) * sizeof(u32));
	u32 *bitmap_s2_a = (u32 *)malloc((1u << bitmap_max) * sizeof(u32));
	u32 *bitmap_s2_b = (u32 *)malloc((1u << bitmap_max) * sizeof(u32));
	u32 *bitmap_s2_c = (u32 *)malloc((1u << bitmap_max) * sizeof(u32));
	u32 *bitmap_s2_d = (u32 *)malloc((1u << bitmap_max) * sizeof(u32));
	...
	generate_bitmaps(hashes->digests_cnt, hashconfig->dgst_size, bitmap_shift1, (char *)hashes->digests_buf, hashconfig->dgst_pos0, hashconfig->dgst_pos1, hashconfig->dgst_pos2, hashconfig->dgst_pos3, bitmap_mask, bitmap_size, bitmap_s1_a, bitmap_s1_b, bitmap_s1_c, bitmap_s1_d, ~0ul);
	generate_bitmaps(hashes->digests_cnt, hashconfig->dgst_size, bitmap_shift2, (char *)hashes->digests_buf, hashconfig->dgst_pos0, hashconfig->dgst_pos1, hashconfig->dgst_pos2, hashconfig->dgst_pos3, bitmap_mask, bitmap_size, bitmap_s2_a, bitmap_s2_b, bitmap_s2_c, bitmap_s2_d, ~0ul);
...
void bitmap_ctx_destroy(bitmap_ctx_t *bitmap_ctx)
{
	...
	free(bitmap_ctx->bitmap_s1_a);
	free(bitmap_ctx->bitmap_s1_b);
	free(bitmap_ctx->bitmap_s1_c);
	free(bitmap_ctx->bitmap_s1_d);
	free(bitmap_ctx->bitmap_s2_a);
	free(bitmap_ctx->bitmap_s2_b);
	free(bitmap_ctx->bitmap_s2_c);
	free(bitmap_ctx->bitmap_s2_d);
